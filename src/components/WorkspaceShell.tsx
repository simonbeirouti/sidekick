...
export function WorkspaceShell({
  ...
  const activeTab =
    ...
    null;
  const displayName =
    readDisplayName(authState.user.userMetadata) ??
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="flex flex-col items-end gap-3">
                <div className="flex min-w-55 items-center gap-2">
                  ...
                  <Select
                    value={provider}
                    onValueChange={(value) => onProviderChange(value as ChatProvider)}
                  >
                    <SelectTrigger
                      id="provider-select"
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent size="sm" className="rounded-none">
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          The Supabase auth account will be soft-deleted and the
                          app data will stay archived for local testing. Signing up
                          again will create a fresh account with a new user id.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
...
function readDisplayName(metadata: Record<string, unknown> | null) {
  if (!metadata) {
    return null;
  }
